...
<div class="max-w-screen-md mx-auto flex items-center mt-10">
    <div class="w-full bg-white rounded-xl px-10 py-8">
        ...
        <h2 class="text-3xl font-semibold mb-7">Laravel 10 CRUD <span class="font-normal text-slate-400">/ Edit
                Student</span></h2>
        ...
        <form action="{{ route('students.update', $student->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea name="address"
                    class="w-full border border-gray-300 px-4 py-2 rounded-md focus:outline-indigo-400">{{ old('address', $student->address) }}</textarea>
                @error('address')
                <div class="text-red-600 text-sm">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3">
                <label for="major_id" class="block mb-1">Program Studi</label>
                <select id="major_id" name="major_id" class="w-full border border-gray-300 px-4 py-2 rounded-md focus:outline-indigo-400 
            ...
            <div class="mb-3">
                <label for="faculty_id" class="block mb-1">Fakultas</label>
                <select id="faculty_id" name="faculty_id" class="w-full border border-gray-300 px-4 py-2 rounded-md focus:outline-indigo-400 
                                       appearance-none bg-no-repeat bg-right pr-8
                                       bg-[url('data:image/svg+xml,%3csvg%20xmlns%3d%22http%3a//www.w3.org/2000/svg%22%20fill%3d%22none%22%20viewBox%3d%220%200%2020%2020%22%3e%3cpath%20stroke%3d%22%236b7280%22%20stroke-linecap%3d%22round%22%20stroke-linejoin%3d%22round%22%20stroke-width%3d%221.5%22%20d%3d%22m6%208%204%204%204-4%22/%3e%3c/svg%3e')]">
            ...
            <div class="flex items-center justify-center gap-5">
                <a href="{{ route('students.index') }}"
                    class="text-white bg-amber-500 px-8 py-2 rounded cursor-pointer">Back</a>
